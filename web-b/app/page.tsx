  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 md:p-8">
      <div className="max-w-md w-full bg-white shadow-2xl rounded-3xl overflow-hidden border border-gray-100">
        ...
        {/* Header section - changed to emerald */}
        <div className="bg-emerald-600 p-8 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-xl font-medium opacity-90 mb-1">Checking Account</h1>
            <h2 className="text-4xl font-extrabold tracking-tight">$8,920.50</h2>
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
            <div>
              <p className="text-sm text-gray-500 font-medium">Transfer to</p>
              <p className="text-lg font-bold text-gray-900">Global Relief Fund</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  readOnly
                  value="500.00"
                  className="block w-full pl-8 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-bold text-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
                />
              </div>
            </div>

            <button 
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-lg py-4 rounded-xl shadow-lg shadow-emerald-200 transition-all transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
              onClick={() => alert("Payment Processed! (This is just a simulation on web-b)")}
            >
              Confirm Payment
            </button>
          </div>
        ...
        <div className="bg-gray-50 px-8 py-5 border-t border-gray-100">
          <div className="flex items-center justify-center text-red-500 mb-6">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider">No Clickjacking Protection</span>
          </div>
